          ...
          <div className={styles.content}>
            ...
            >
              ...
              <div className={styles.list}>
                <ul>
                  <li>
                    Nel momento in cui l&apos;utente accede ai nostri servizi,
                    tra cui: server Minecraft, Discord e web è sottoposto
                  ...
                  <li>
                    ...
                    all&apos;interno dei nostri servizi attraverso il suo
                    account, anche se queste non sono state direttamente da lui
                    commesse.
                    <ul>
                      <li>
                        l&apos;utente si impegna ad avere pieno controllo del
                        proprio account, attuando una serie di comportamenti e
                        procedure per tutelare l&apos;accesso al suo account,
                        per esempio, impostando password sicure e ad astenersi
                        dal diffondere informazioni personali o nel diffondere
                        (anche prestando) il proprio account.
                      </li>
                    </ul>
                  </li>
                  <li>
                    Lo staff ha tutta l&apos;autorità necessaria per far
                    ...
                    <ul>
                      ...
                      <li>
                        Per sanzioni &quot;disciplinari&quot; si intendono tutte
                        quelle azioni che portano ad un allontanamento dal
                        server o ad un divieto di utilizzo della chat, tali
                        sanzioni possono essere temporanee e permanenti in base
                        alle diverse situazioni definite dal regolamento.
                      </li>
                      <li>
                        Per sanzioni &quot;tecniche&quot; si intendono tutte
                        quelle azioni che non portano ad allontanamenti dal
                        server o dall&apos;utilizzo della chat, ma rimozione di
                        oggetti, eliminazione di strutture, reset
                        dell&apos;account e la rimozione di oggetti o privilegi
                        acquistati nel nostro store.
                      </li>
                      <li>
                        ...
                        60 giorni di mute; in caso, un&apos;infrazione preveda
                        come pena il ban o mute permanente verrà applicata solo
                        tale sanzione disciplinare con eventuale sanzione
                        tecnica.
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        Per presentare una segnalazione verso un&apos;utente o
                        un membro dello staff, non devono essere passati più di
                        7 giorni dal momento dall&apos;accaduto, di conseguenza
                        una segnalazione presentata in ritardo verrà
                        immediatamente rifiuta e scartata. (è fatta deroga la
                        possibilità di mantenere materiale/prove “incriminanti”
                        verso un qualsiasi utente o staff fino a 30 giorni per
                        consentire di effettuare un&apos;unica segnalazione in
                        caso di recidività in piccole infrazioni).
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        hanno l&apos;ultima parola su tutto e su ogni
                        situazione, in caso di assenza di prove o prove ritenute
                        non sufficientemente valide.
                      </li>
                      <li>
                        I reclami devono essere effettuati attraverso
                        l&apos;apposita sezione nel nostro server Discord
                        seguendo le indicazioni presenti e fornendo opportuna
                        documentazione scritta e visiva (foto, video); in caso
                        di mancanza o prove non ritenute sufficientemente
                        valide, si applica il punto 1.5.a del regolamento.
                      </li>
                      <li>
                        ...
                        considerazione se effettuati entro 48 ore
                        dall&apos;avvenuta sanzione e/o sanzioni.
                      </li>
                      <li>
                      ...
                      <li>
                        L&apos;esito relativo alle decisioni prese a proposito
                        dei reclami ricevuti viene pubblicato e comunicato entro
                        24 ore dall&apos;effettuazione del reclamo.
                      </li>
                      <li>
                        ...
                        &quot;reclamo&quot; che prevede un aumento della
                        sanzione &quot;disciplinare&quot; precedente di 3 giorni
                        di ban e/o 2 giorni di mute; in caso di non presenza di
                        sanzione disciplinare la sanzione &quot;reclamo&quot;
                        prevede 1 giorno di ban; la sanzione reclamo viene
                        applicata anche in caso di reclami aperti per altri e/o
                        per perdita di tempo allo staff con possibili
                        aggravanti.
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        Al passare di un anno dalla data dell&apos;ultima
                        infrazione, il conteggio delle aggravanti per recidività
                        nella stessa infrazione sarà azzerato.
                      </li>
                      <li>
                        Oltre alle aggravanti esistono anche delle attenuanti
                        che in base alla situazione valutata
                        dall&apos;amministratore incaricato potrebbero ridurre
                        la durata della o delle sanzioni a sua discrezione.
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    determinata situazione vige il buon senso dell&apos;utente e
                    ogni azione considerata dannosa per il server o per gli
                    altri utenti o che mette l&apos;utente in questione in una
                    situazione di vantaggio eccessivo (per un bug o altre
                    problematiche) sarà sanzionata a discrezione dello staff
                    secondo le linee guida dettate dal regolamento.
                  </li>
                  <li>
              ...
              <div className={styles.list}>
                <ul>
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        forzato) è assolutamente vietato l&apos;amministrazione
                        di RagnarokMC, si riserva il diritto di modificare o
                  ...
                  <li>
                    ...
                    punto, comporta: un avvertimento (warn) e
                    l&apos;impossibilità di effettuare un&apos;ulteriore
                    candidatura per 1 mese dalla data in questione.
                    <ul>
                      <li>
                        L&apos;esito delle candidature avverrà entro 7 giorni e
                        solo in caso di esito positivo verrà successivamente
                        concordato il colloquio orale e/o pratico, inoltre,
                        contattare continuamente lo staff in merito
                        all&apos;esito della propria candidatura comporterà la
                        sanzione del punto 2.3, tuttavia dopo 7 giorni è
                        possibile richiedere tramite apposita sezione su discord
                        l&apos;esito della propria prova scritta.
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    dell&apos;account da 7 a 21 giorni salvo aggravanti e
                    attenuanti.
                    <ul>
                      <li>
                        Una persona non può creare più account con lo scopo di
                        ottenere più ricompense giornaliere o con lo scopo di
                        ottenere vantaggi in generale. L&apos;infrazione
                        comporta: sospensione permanente dell&apos;account
                        doppione e warn o possibile sospensione temporanea
                        dell&apos;account principale di 1 giorno in base alla
                        situazione.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        comporta: sospensione permanente dell&apos;account
                        doppione e aumento del 100% della pena nel account
                        precedentemente sanzionato (in caso di sanzione
                        temporanea).
                      </li>
                    </ul>
                  </li>
                  <li>
                    L&apos;account di un&apos;utente è strettamente personale ed
                    è assolutamente vietato cercare di impossessarsi di un
                    account non proprio per la quale non si ha il diritto di
                    utilizzo. L&apos;infrazione comporta: una sanzione
                    disciplinare di sospensione dell&apos;account del colpevole
                    per 2 mesi (60 giorni).
                    <ul>
                      <li>
                        In caso il furto dell&apos;account sia rivolto ad un
                        account di tipo STAFF L&apos;infrazione comporta:
                        sospensione permanente e definitiva da tutti i nostri
                        servizi per l&apos;account del trasgressore.
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    altre tecniche di hackeraggio e/o comunque con
                    l&apos;intento generale di griffare/danneggiare il server,
                    rubare dati e informazioni sensibili e compromettere in
                    generale l&apos;integrità e la sicurezza dei nostri servizi
                    comporta: sospensione permanente e definitiva di tutti gli
                    account collegati da tutti i nostri servizi.
                    <ul>
                      <li>
                  ...
                  <li>
                    ...
                    consentita. L&apos;infrazione comporta: invito warn a
                    cambiarsi il nome dell&apos;account salvo aggravanti, in
                    caso di impossibilità nel cambiarsi il nome ci sarà la
                    sospensione permanente dell&apos;account di gioco.
                    <ul>
                      <li>
                        Non è possibile entrare nel server con nomi molto simili
                        a quelli degli staffer. L&apos;infrazione comporta:
                        invito warn a cambiarsi il nome salvo aggravanti.
                      </li>
                      <li>
                        Non è consentito fingersi staffer o creare un account
                        con nome simile ad uno staffer per facilitare un
                        possibile imbroglio. L&apos;infrazione comporta: invito
                        warn a cambiarsi il nome e sospensione temporanea
              ...
              <div className={styles.list}>
                <ul>
                  <li>
                    ...
                    giustificate come “uno scherzo” o &quot;non era rivolta a
                    te&quot; senza nessuna attenuante.
                    <ul>
                      <li>
                        è vietato offendere e insultare in qualsiasi modo
                        possibile; l&apos;infrazione comporta: mute da 15 minuti
                        a 10 giorni e/o ban da 12 ore a 5 giorni.
                      </li>
                      <li>
                        è vietato minacciare in ogni modo possibile;
                        l&apos;infrazione comporta: mute da 6 ore a mute di 21
                        giorni e/o ban da 1 a 10 giorni salvo aggravanti.
                      </li>
                      <li>
                        è vietato inviare troppi messaggi uguali o simili in
                        breve periodo di tempo (flood); l&apos;infrazione
                        comporta: mute da 15 minuti a 1 giorno.
                      </li>
                      <li>
                        è vietato inviare messaggi con parole scritte in
                        maiuscolo (CAPS) è al massimo consentito l&apos;utilizzo
                        di una parola caps per messaggio (formato da più
                        parole); l&apos;infrazione comporta: un warn e un
                        possibile mute da 15 minuti a 1 giorno.
                      </li>
                      <li>
                        è vietato scrivere messaggi con contenuti politici,
                        razzisti, sessuali, discriminatori, religiosi e
                        blasfemi; l&apos;infrazione comporta: mute da 30 minuti
                        a 5 giorni e/o ban da 12 ore a ban di 5 giorni.
                      </li>
                      <li>
                        è vietato rivelare informazioni/spoiler su film, giochi,
                        puntate televisive e simili l&apos;infrazione comporta:
                        mute da 1 ora a 7 giorni e/o ban da 1 a 5 giorni.
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    giocatori o richieste di supporto all&apos;interno del gioco
                    è proibito; l&apos;infrazione comporta: un warn fino ad un
                    ban di 2 giorni.
                  </li>
                  <li>
                  ...
                  <li>
                    Non è consentito impostarsi il colore del nome
                    dell&apos;account (se si ha il permesso di farlo) con colori
                    o formati che ne rendono difficile la comprensione;
                    l&apos;infrazione comporta: un warn e/o un ban di 1 giorno.
                  </li>
                  <li>
                    Non è consentito divulgare informazioni commerciali di altri
                    servizi, fare pubblicità, inviare indirizzi di altri network
                    (SPAM); l&apos;infrazione comporta: un mute da 5 a 45 giorni
                    e/o un ban da 2 a 30 giorni.
                    <ul>
                      <li>
                  ...
                  <li>
                    L&apos;invio di indirizzi web esterni al network o
                    sponsorizzare video live e non con l&apos;utilizzo di
                    qualsiasi social e/o piattaforma è vietato;
                    l&apos;infrazione comporta: un mute da 1 a 30 giorni e/o un
                    ban da 1 a 7 giorni.
                  </li>
                  <li>
                    Spawn-killare o Tp-killare in qualsiasi modalità/occasione,
                    salvo autorizzazione, è vietato e l&apos;infrazione
                    comporta: un warn e/o un ban di 1 giorno (con possibile
                    incremento) per tutti i responsabili.
                    <ul>
                      <li>
                  ...
                  <li>
                    ...
                    discriminatorie; l&apos;infrazione comporta: un warn o un
                    ban di 1 giorno a seconda dei casi e rimozione della
                    struttura.
                  </li>
                </ul>
              </div>
              ...
              <div className={styles.list}>
                <ul>
                  <li>
                    ...
                    un vantaggio in gioco è tassativamente vietata,
                    l&apos;utente è invitato a segnalare ogni trasgressore per
                    evitare di esserne complice e quindi di subire una sanzione.
                    <ul>
                      <li>
                      ...
                      <li>
                        ...
                        autocliker/macro è vietato; l&apos;infrazione comporta:
                        un ban di 10 giorni se cheats evidenti, ban di 7 giorni
                        se l&apos;utente ammette.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        considerarsi vietato; pertanto, in caso l&apos;utente ne
                        stia facendo uso sarà sanzionabile secondo il punto
                        “4.1.a” con motivazione “Utilizzo di client/mod non
                        ammesse”. NON AMMESSE: Labymod, Bridge mod, batMod,
                        Lithium client, Geyser mod, GodBridge, ModMenu, Voxel
                        Map, Xaeros Minimap, Pixel Client, Linematica, Pactify
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        degli anticheat o degli altri utenti) che l&apos;utente
                        stia imbrogliando.
                      </li>
                      <li>
                      ...
                      <li>
                        L&apos;utente ha il diritto di rifiutare un controllo
                        hack per qualsiasi validissima ragione ma dovrà essere
                      ...
                      <li>
                        ...
                        per qualche motivo l&apos;utilizzo/avvio dei tool citati
                        nel punto 4.2.2 anche per motivi non conosciuti
                        dall&apos;utente stesso comporta: un ban di 10 giorni
                        per “Impossibilità di controllo cheats per
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        Essere a conoscenza di un qualsiasi bug all&apos;interno
                        del server e senza farne uso, si decide di diffonderlo,
                        ...
                        in base alla situazione reset completo dell&apos;account
                        di gioco).
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    indicazione da parte dello staff; l&apos;infrazione
                    comporta: un warn fino ad arrivare ad un ban permanente e
                    rimozione dei vantaggi ottenuti (o in base alla situazione
                    reset completo dell&apos;account di gioco).
                  </li>
                </ul>
              </div>
            ...
            >
              ...
              <div className={styles.list}>
                <ul>
                  ...
                  <li>
                    è vietato menzionare lo staff all&apos;interno del ticket,
                    in quanto una volta aperto, gli staffer disponibili vengono
                    già avvisati.
                  </li>
                  <li>
